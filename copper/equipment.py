...
class Equipment:
    ...
    def convert_to_deg_c(value, unit="degF"):
        ...
        :return: Value converted to degree C
        :rtype: float
        """
        if unit == "degF":
    ...
    def get_eir_ref(self, alt):
        """Get the reference EIR (energy input ratio) of equipment.
    ...
    def generate_set_of_curves(
        ...
        :param list() vars: List of variable to run the algorithm on
        ...
        :param int random_seed: Integer that is used to initialize the random number generator, this should be used when identical results are needed from one run to another
