...
You might be interested in **Copper** if you are an energy modeler, engineer, or researcher wanting to generate simulation-ready performance curves that match a set of specific design characteristics and efficiencies.
